# Amazon Ratings and Reviews Web Scraper using Python
A simple Python web scraper to extract Reviews and Ratings from Amazon's Product Display Page

## Click to open the Notebook directly in Google Colab
<!-- [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/bhattbhavesh91/amazon-ratings-reviews-scrapper-python/blob/main/amazon-r-r-extractor-notebook.ipynb)
 -->
 
<a href="https://colab.research.google.com/github/bhattbhavesh91/amazon-ratings-reviews-scrapper-python/blob/main/amazon-r-r-extractor-notebook.ipynb" target="_blank"><img height="40" alt="Open in Colab" src = "https://colab.research.google.com/assets/colab-badge.svg"></a>
